// This file is only used for DOM Manipulation
...
export class UI {
    ...
    // Callback fruction is accepted as an input
    ...
    static setTurn(index) {
        ...
        // highlighting the player base of the player
        document.querySelector(`[player-id="${player}"].player-base`).classList.add('highlight')
    }

    // enabling the roll button when player has its turn
    static enableDice() {
        diceButtonElement.removeAttribute('disabled');
    }
    
    // disabling the roll button when player has no turn
    static disableDice() {
